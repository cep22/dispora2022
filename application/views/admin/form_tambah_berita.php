...
<div class="container" style="margin-top: 40px">
    ...
    <form class="form-horizontal" method="post" action="<?php echo base_url()."index.php/c_admin/insert_berita/" ?>">            
            ...
            <div class="form-group">
                <label class="control-label col-sm-2">Sumber Berita/Penulis</label>
                <div class="col-sm-10">
                    <input type="text" name="sumber" class="form-control" placeholder="Masukkan Sumber Berita">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-sm-2">Isi berita</label>
                <div class="col-sm-10">
                    <textarea class="form-control" rows="7" name="isi" id="editor"></textarea>
                </div>
            </div>
            <script>
